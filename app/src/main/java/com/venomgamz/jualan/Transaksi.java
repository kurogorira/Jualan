            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                alertDialogBuilderUserInput.setCancelable(false).setPositiveButton("Tambah", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dbc.insertDataPesanan(sendName,Integer.parseInt(sendHarga),Integer.parseInt(jumlah.getText().toString()),Integer.parseInt(sendHarga)*Integer.parseInt(jumlah.getText().toString()));
                    }
                })
